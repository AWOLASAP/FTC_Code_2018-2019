...
@Autonomous(name="Encoder Auto CRATER", group="Linear Opmode")
public class Encoder_auto_CRATER extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        right.setPower(-1);
        left.setPower(-1);
        while(opModeIsActive() && right.getCurrentPosition() < 10000){
